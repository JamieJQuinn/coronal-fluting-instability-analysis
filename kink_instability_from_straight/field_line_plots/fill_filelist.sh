#!/usr/bin/env bash
ISOTROPIC_DIR=/nas/1101974q/archie-latest-organisation-sept-2018/kink-instabilities/from-straight-tube/single_run/v-4r-4-isotropic
SWITCHING_DIR=/nas/1101974q/archie-latest-organisation-sept-2018/kink-instabilities/from-straight-tube/single_run/v-4r-4-switching
...
echo ${ISOTROPIC_DIR}/Data/0014_preprocessed.vti | sed -e 's/ /\\n/g' >> filename_list
echo ${SWITCHING_DIR}/Data/0014_preprocessed.vti | sed -e 's/ /\\n/g' >> filename_list
